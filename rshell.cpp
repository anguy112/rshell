...
void cmd_parsing (char * inputStr, char ** command){
    ...
    // format input string so that a space is always before the connector
    ...
    for (int i=0; i < inputLen; i++)
    {
            ...
            if ((inputStr[i]==';') || (inputStr[i]=='|') || (inputStr[i]=='&'))
            {
                ...
                inputStr[foundIndex]=' ';       // insert space
                ++inputLen;
...
// this fuction perform the command using execvp and return the status
